...
Po uruchomieniu gry ukazuje nam się menu gry, które pozwala rozpocząć nową rozgrywkę

5. Założenia projektu : (zostaną zmienione oraz wzbogacone o detale na kolejnych etapach projektu)
